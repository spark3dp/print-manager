...
, testpath = path.resolve(__dirname + '/files/makerbot-octopus.gcode')
...
function getPrinter(){
  ...
  .get(URL + '/print/printers?type_id=F2F4B9B6-1D54-4A16-883E-B0385F27380D')
  .afterJSON(function (json){
...
function uploadJobToPrinter(){
  frisby.create('upload a job to type a')
